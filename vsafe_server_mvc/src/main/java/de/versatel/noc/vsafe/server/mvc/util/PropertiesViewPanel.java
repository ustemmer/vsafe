...
import de.versatel.noc.vSafe_Server.mvc.utilities.JFontChooserDialog;
...
public class PropertiesViewPanel extends AbstractViewPanel {
    ...
    public void modelPropertyChange(final PropertyChangeEvent evt) {
        ...
        if (evt.getPropertyName().equals(TextElementModel.X)) {
        ...
        } else if (evt.getPropertyName().equals(TextElementModel.Y)) {
        ...
        } else if (evt.getPropertyName().equals(TextElementModel.OPACITY)) {
        ...
        } else if (evt.getPropertyName().equals(TextElementModel.ROTATION)) {
        ...
        } else if (evt.getPropertyName().equals(TextElementModel.TEXT)) {
        ...
        } else if (evt.getPropertyName().equals(TextElementModel.FONT)) {
        ...
        } else if (evt.getPropertyName().equals(DocumentModel.NAME)) {
        ...
        } else if (evt.getPropertyName().equals(DocumentModel.WIDTH)) {
        ...
        } else if (evt.getPropertyName().equals(DocumentModel.HEIGHT)) {
